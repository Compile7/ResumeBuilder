...
<div class="page mx-auto" style={fontStyle}>
	<div id="preview" class="bg-white flex flex-col max-w-3xl mx-auto px-4 py-6 h-full">
		<!-- header -->
		...
		<div class="flex flex-col p-6 ">
			...
			<div class="profile border-b border-solid border-gray-300 py-6">
				<h2 class="text-xl font-medium mb-3">Profile</h2>
			...
			<div class="flex pt-6">
				...
				<div class="w-8/12 border-r border-solid border-gray-300 pr-4">
					<h2 class="text-xl font-medium mb-3">Education</h2>
					<div class="mb-8">
					...
					<h2 class="text-xl font-medium mb-3 mt-12">Employment</h2>
				...
				<div class="w-4/12 pl-4">
					...
					<h2 class="text-xl font-medium mb-3 mt-12">Hobbies</h2>
					<div class="flex flex-col p-6  gap-2">
