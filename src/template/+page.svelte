				...
				<div class="flex  gap-6">
					<p class="w-1/2">
						<a href="/" class="text-gray-500"
							><span class="text-gray-900">Email:</span> hiteshkumawat19@gmail.com</a
						>
					</p>
					<p class="w-1/2">
						<a href="/" class="text-gray-500"
		...
		<div class="flex pt-6">
			...
			<div class="w-4/12 pl-4">
				...
				<div class="flex flex-wrap gap-1">
					...
					>
					<label for="" class="bg-gray-900 text-white px-2 py-1 text-xs rounded-full">CSS3</label>
					<label for="" class="bg-gray-900 text-white px-2 py-1 text-xs rounded-full">SCSS</label>
					<label for="" class="bg-gray-900 text-white px-2 py-1 text-xs rounded-full"
						>Tailwind.css</label
					>
					<label for="" class="bg-gray-900 text-white px-2 py-1 text-xs rounded-full">LESS</label>
					<label for="" class="bg-gray-900 text-white px-2 py-1 text-xs rounded-full"
						>Javascript</label
					>
					<label for="" class="bg-gray-900 text-white px-2 py-1 text-xs rounded-full"
						>Typescript</label
					>
					<label for="" class="bg-gray-900 text-white px-2 py-1 text-xs rounded-full">Node.js</label
					>
					<label for="" class="bg-gray-900 text-white px-2 py-1 text-xs rounded-full">JSX</label>
					<label for="" class="bg-gray-900 text-white px-2 py-1 text-xs rounded-full">React</label>
					<label for="" class="bg-gray-900 text-white px-2 py-1 text-xs rounded-full"
						>React-Router</label
					>
					<label for="" class="bg-gray-900 text-white px-2 py-1 text-xs rounded-full">Next.js</label
					>
